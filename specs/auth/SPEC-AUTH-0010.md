...
- [ ] AC-22: Logged-in user can change their password with valid credentials and a new password meeting requirements
- [ ] AC-23: System returns an error if the current password is incorrect
- [ ] AC-24: System returns an error if the new password has less than 8 characters
- [ ] AC-25: System returns an error if the new password matches the current password
- [ ] AC-26: System returns clear error messages for each failure case
- [ ] AC-27: Response time is under 500ms at p95
